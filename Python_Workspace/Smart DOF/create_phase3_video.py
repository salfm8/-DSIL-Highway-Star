...
step3_path = "step3_tracking_dof.mp4"
out_path = "phase3_video_comparison.mp4"

cap1 = cv2.VideoCapture(orig_path)
cap2 = cv2.VideoCapture(step3_path)
...
while True:
    ...
    cv2.putText(f2, 'True Optical Tracking (Phase 3)', (10, 40), font, 1.0, (100,255,100), 2)
